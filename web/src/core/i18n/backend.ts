...
const MAP: Record<string, { uzc: string; ru: string; en: string }> = {
  ...
  "Bu amal uchun tasdiqlangan xonadon a'zosi bo'lishingiz kerak": { uzc: 'Бу амал учун тасдиқланган хонадон аъзоси бўлишингиз керак', ru: 'Для этого действия нужно быть членом подтверждённого дома', en: 'You must be a member of a verified household for this action' },
  ...
  "Faqat tasdiqlangan xonadon a'zolari kafolat bera oladi": { uzc: 'Фақат тасдиқланган хонадон аъзолари кафолат бера олади', ru: 'Поручиться могут только члены подтверждённого дома', en: 'Only members of a verified household can vouch' },
  ...
  "O'zingizni shikoyat qila olmaysiz": { uzc: 'Ўзингизни шикоят қила олмайсиз', ru: 'Нельзя пожаловаться на себя', en: "You can't report yourself" },
  ...
  'Shikoyat topilmadi': { uzc: 'Шикоят топилмади', ru: 'Жалоба не найдена', en: 'Report not found' },
  ...
  'Siz allaqachon shikoyat qildingiz': { uzc: 'Сиз аллақачон шикоят қилдингиз', ru: 'Вы уже пожаловались', en: 'You already reported this' },
